...
# Input STAR file
in_star = ROOT_PATH + '/org/pre/in/all_pre_AP1_AP2_att3.star' # '/org/pre/in/all_pre_v6_chr_ref_att2.star' # '/org/pre/in/all_pre_v6_chr_ref.star' # '/org/pre/in/all_pre_avgs.star' # '/org/pre/in/all_pre_v6.star'
...
# Output directory
out_dir = ROOT_PATH + '/org/pre/ltomos/ltomos_pre_pre_AP1_AP2_att3_xd10nm' # '/org/pre/ltomos/ltomos_pre_pre_v6_chr_ref_att2_xd10nm' # '/org/pre/ltomos/ltomos_pre_pre_v6_chr_ref_xd5nm' # '/org/pre/ltomos/ltomos_all_pre_avgs' # '/org/pre/ltomos/ltomos_all_v6_pre_pre_ss7.31px_min10' # '/ref_a3/ltomos'
out_stem = 'pre_pre_AP1_AP2_att3_xd10nm' # 'pre_pre_v6_chr_ref_att2_xd10nm' # 'pre_pre_v6_chr_ref_xd5nm' # 'all_pre_avgs' # 'pre'
