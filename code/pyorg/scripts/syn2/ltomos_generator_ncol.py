...
# Input STAR file
in_star = ROOT_PATH + '/org/ncol/in/all_ncol_v3_ltomos.star' # '/org/col/in/all_xd5nm_ltomos.star' # '/org/col/in/all_test_ltomos.star'

# Input STAR for with the sub-volumes segmentations
in_seg = '/fs/pool/pool-lucic2/antonio/workspace/psd_an/in/syn_seg_no_l14_gap_zeros_fits.star' # '/fs/pool/pool-lucic2/antonio/workspace/psd_an/in/syn_seg_no_l14_gap_zeros_fits.star'

# Output directory
out_dir = ROOT_PATH + '/org/ncol/ltomos/ltomos_ncol_v3' # '/org/ncol/ltomos/ltomos_ncol_tmin3_min5' # '/org/col/ltomos/ltomos_all_scol_test'
out_stem = 'all_ncol_v3' # 'all_ncol_tmin3_min5' # 'all_scol_test' # 'pre'
