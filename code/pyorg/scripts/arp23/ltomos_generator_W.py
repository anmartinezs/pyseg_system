...
# Input STAR file
in_star = ROOT_PATH + '/ltomos2/in_ltomos_waves4.star' # '/ref_a3/mask_20_50_12_surfs.star'
...
# Output directory
out_dir = ROOT_PATH + '/ltomos_sep/W_sep_mask' # '/ref_a3/ltomos'
...
sg_dmap_path = ROOT_PATH + '/ltomos_sep/W_sep_mask/dmaps'
