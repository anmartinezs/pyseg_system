...
# Input STAR file
in_star = ROOT_PATH + '/in/example_bref_16_parts.star'

# Input STAR for with the sub-volumes segmentations
in_seg = ROOT_PATH + '/in/cluster_seg_reduced.star'

# Output directory
out_dir = ROOT_PATH + '/ltomos/test_reduced' # '/stat/ltomos/trans_run2_test_swapxy'
out_stem = 'test_reduced' # 'pre'
