...
ROOT_PATH = '/fs/pool/pool-ruben/antonio/groel' # '/fs/pool/pool-plitzko/Saikat/luminal_particle_organization/lattice_break_clustering'

# Input STAR file
in_star_ref = ROOT_PATH + '/ltomos/tomo12006_all/all_ltomos.star' # '/ltomos/v1_nobc_proj/v1_nobc_proj_ltomos.star'
in_ref_short_key = '4' # '0'
in_star = ROOT_PATH + '/ltomos/tomo12006_all/all_ltomos.star' # '/ltomos/v1_nobc_proj/v1_nobc_proj_ltomos.star'  #
...
# Output directory
out_dir = ROOT_PATH + '/ana/tomo12006' # '/org/bi/bi_2nd/'
out_stem = 'bi_2nd_ref_4_8_300_3_sim_20_rdf_10_switch_over0.05' # 'v1_nobc_proj_sph_10_600_10'  # 'uni_sph_4_60_5'

# Analysis variables
ana_res = 1.368  # nm/voxel
ana_rg = np.arange(8, 300, 3)  # in nm
ana_shell_thick = 10 # 5 # None
ana_rdf = True # True
ana_fmm = False
