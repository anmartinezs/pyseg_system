...
# Input STAR file
in_star_pre = ROOT_PATH + '/ltomos_method_1_az/3_pre_az_pst_tether_ltomos.star' # '/ltomos_nn/ltomos_2_2_2/az_pst_all_premb_2_2_2_ltomos.star' # '/ltomos_ves_40_lap_gather_gather/ves_40_lap_gather_gather_premb_ltomos.star'
key_pre = 'COL'
in_star_pre_a = ROOT_PATH + '/ltomos_method_1_az/3_pre_az_pst_tether_ltomos.star' # '/ltomos_nn/ltomos_2_2_2/az_pst_all_premb_2_2_2_ltomos.star' # '/ltomos_ves_40_lap_gather_gather/ves_40_lap_gather_gather_premb_ltomos.star'
key_pre_a = 'PRE' # 'PST_AP'
in_star_pre_b = ROOT_PATH + '/ltomos_method_1_az/3_pre_az_pst_tether_ltomos.star' # '/ltomos_nn/ltomos_2_2_2/az_pst_all_premb_2_2_2_ltomos.star' # '/ltomos_ves_40_lap_gather_gather/ves_40_lap_gather_gather_premb_ltomos.star'
key_pre_b = 'TETHER' # 'PRE'
in_star_pre_c = ROOT_PATH + '/ltomos_method_1_az/3_pre_az_pst_tether_ltomos.star' # '/ltomos_nn/ltomos_2_2_2/az_pst_all_premb_2_2_2_ltomos.star' # '/ltomos_ves_40_lap_gather_gather/ves_40_lap_gather_gather_premb_ltomos.star'
key_pre_c = 'PST' # 'PRE_AP'
in_tethers_csv = ROOT_PATH + '/../pre/ref_nomb_1_clean/py_scripts/syn_num_tethers.csv'
in_wspace = None # ROOT_PATH + '/uni_col/uni_sph_method_1/uni_15_105_5_sim_200_local_ssup_8_wspace.pkl' # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/uni_col/uni_shell_method_1_az'
out_stem = 'uni_1_102_2_sim_20_local_ssup_5' # ''uni_sph_4_60_5'
...
if in_wspace is None:
    ...
    ltomos_pkl = star_pre_a.get_element('_psPickleFile', 1)
    list_pre_a = unpickle_obj(ltomos_pkl)
    ltomos_pkl = star_pre_b.get_element('_psPickleFile', 2)
    list_pre_b = unpickle_obj(ltomos_pkl)
    ltomos_pkl = star_pre_c.get_element('_psPickleFile', 3)
