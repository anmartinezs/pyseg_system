...
# Input STAR file
in_star = ROOT_PATH + '/ref_nomb_1_clean/mask_20_50_12_surfs_ABC.star'
...
# Output directory
out_dir = ROOT_PATH + '/ref_nomb_1_clean/ltomos_pre_premb_ABC' # '/ref_a3/ltomos'
out_stem = 'pre_premb_ABC' # 'pre'
