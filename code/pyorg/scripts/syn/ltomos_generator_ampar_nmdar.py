...
# Input STAR file
in_star = ROOT_PATH + '/in/ampar_nmdar_c2_surfs.star'
...
# Output directory
out_dir = ROOT_PATH + '/ltomos/ltomos_ampar_nmdar_c2_pstmb_mask_n' # '/ref_a3/ltomos'
out_stem = 'ampar_nmdar_c2_pstmb_gather_mask' # 'pre'
