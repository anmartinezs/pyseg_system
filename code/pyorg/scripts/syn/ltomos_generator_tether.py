...
# Input STAR file
in_star = ROOT_PATH + '/ves_ap/ves_ap_parts.star'

# Input STAR for with the sub-volumes segmentations
in_seg = '/fs/pool/pool-lucic2/antonio/workspace/psd_an/in/syn_seg2_no_l14_gap.star' # ROOT_PATH + '/in/syn_seg_11_2.star'

# Output directory
out_dir = ROOT_PATH + '/ves_ap/ltomos_ves_ap_cleft' # '/ref_a3/ltomos'
out_stem = 'ves_ap_cleft' # 'pre'
