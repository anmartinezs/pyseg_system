...
# Input STAR file
in_star = ROOT_PATH + '/in/method_1/3_pre_tether_pst_surfs.star' # '/in/nn_3_3_3/col_sim_3_maxd_15_nn1_3_nn2_3_nn3_3_test_surfs.star'
...
# Output directory
out_dir = ROOT_PATH + '/ltomos_method_1/' # '/ltomos_nn/ltomos_3_3_3' # '/ref_a3/ltomos'
out_stem = '3_pre_tether_pst' # 'pre'
