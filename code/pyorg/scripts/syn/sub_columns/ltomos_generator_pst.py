...
# Input STAR file
in_star = ROOT_PATH + '/in/pst_org.star'
...
# Output directory
out_dir = ROOT_PATH + '/ltomos/ltomos_pst_org_pst_swapxy_ssup5_min5' # '/stat/ltomos/trans_run2_test_swapxy'
out_stem = 'pst_org' # 'pre'
...
sg_origins = (1, 1, 1, 1, 1) # If not None, subtomoavg shiftings are considered,
