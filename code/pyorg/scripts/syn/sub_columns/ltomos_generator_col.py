...
# Input STAR file
in_star = ROOT_PATH + '/in/col_pre_tether_pst_lyr1_org.star'

# Input STAR for with the sub-volumes segmentations
in_seg = '/fs/pool/pool-lucic2/antonio/workspace/psd_an/in/syn_seg2_no_l14_gap.star'

# Output directory
out_dir = ROOT_PATH + '/ltomos/ltomos_col_lyr1_pre_tether_pst_swapxy' # '/stat/ltomos/trans_run2_test_swapxy'
out_stem = 'col_lyr1_pre_tether_pst_swapxy' # 'pre'
...
for star_row in range(star.get_nrows()):
    ...
    part_star_str  = star.get_element('_psStarFile', star_row)
    part_surf_str  = star.get_element('_suSurfaceVtp', star_row)
