...
# Input STAR file
in_star = ROOT_PATH + '/ltomos/ltomos_pst_org_pst_swapxy_ssup5_min5/pst_org_ltomos.star'
...
# Output directory
out_dir = ROOT_PATH + '/col_svol/uni_2nd_pst_org/'
out_stem = 'pst_fmm_8_150_5_sim_200_2'
