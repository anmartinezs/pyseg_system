...
# Input STAR file
in_star = ROOT_PATH + '/ltomos/ltomos_col_lyr1_pre_tether_pst_swapxy/col_lyr1_pre_tether_pst_swapxy_ltomos.star'
in_wspace = None # ROOT_PATH + '/col_svol/uni_2nd_pst_org/pst_fmm_8_200_10_sim_200_wspace.pkl' # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/col_svol/uni_2nd_col_pre_tether_pst_lyr1_org/'
out_stem = 'pst_fmm_8_150_5_sim_200'
