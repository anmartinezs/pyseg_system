...
# Input STAR file
in_star = ROOT_PATH + '/in/an_split.star'
...
# Output directory
out_dir = ROOT_PATH + '/ltomos/ltomos_an_pre_2' # '/stat/ltomos/trans_run2_test_swapxy'
out_stem = 'an_pre2' # 'pre'
