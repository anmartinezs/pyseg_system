...
# Input STAR file
in_star_ref = ROOT_PATH + '/pst/nrt/ltomos_clst_flt_high_lap/clst_flt_high_lap_ltomos.star' # '/ves_40/ltomos_premb_mask/premb_mask_ltomos.star'
in_ref_short_key = '0'
in_star = ROOT_PATH + '/ves_40/ltomos_lap/lap_ltomos.star' # '/pst/nrt/ltomos_clst_flt_high/k4_gather_clst_flt_high_ltomos.star'
...
# Output directory
out_dir = ROOT_PATH + '/pst/nrt/bi_1st_ves_40_k4_gather_lap_tomos'
out_stem = 'bi_sim_20' # ''uni_sph_4_60_5'
