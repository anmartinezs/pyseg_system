...
# Input STAR file
in_star = ROOT_PATH + '/ltomos/rapa_tomo2_mask_l/rapa_tomo2_mask_l_ltomos.star' # '/ltomos/control_mask/control_mask_ltomos.star'
in_wspace = None # ROOT_PATH + '/by_tomos/uni_shell_rapa_tomo2_80S/uni_20_800_3_sim_1_wspace.pkl' # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/by_tomos/uni_shell_rapa_tomo2_80S'
out_stem = 'uni_20_400_3_sim_1_debug' # 'uni_4_60_2_sim_10'

# Analysis variables
ana_res = 2.096 # nm/voxel
ana_rg = np.arange(20, 400, 3) # in nm
ana_shell_thick = 10 # 5
ana_border = True
ana_conv_iter = 10 # 100
ana_max_iter = 100000
...
p_per = 5 # %
# Particle surface
p_vtp = '/fs/pool/pool-engel/antonio/ribo/in/yeast_80S/yeast_80S_21A_mirr_centered.vtp'
...
plt.xlabel('Scale (nm)')
# Plot by tomos
for tkey, tdic in zip(tomos_exp.iterkeys(), tomos_exp.itervalues()):
    for lkey, arr in zip(tdic.iterkeys(), tdic.itervalues()):
        try:
