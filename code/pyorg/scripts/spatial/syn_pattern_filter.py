...
# Input STAR file
in_star = ROOT_PATH + '/nrt/ltomos_k4_gather_premb_mask/k4_gather_premb_mask_ltomos.star'

# Input Simulation matrix
in_sims_set = ROOT_PATH + '/nrt/uni_k4_gather_tomos/uni_sim_100_ss7_lsims.pkl' # If None then they will be computed

# Output directory
out_dir = ROOT_PATH + '/nrt/ltomos_clst_flt_high_2'
out_stem = 'pre_gather_clst_flt_high_2' # ''uni_sph_4_60_5'
