...
# Input STAR file
in_star_ref = ROOT_PATH + '/ves_40/ltomos_lap/lap_ltomos.star' # '/ves_40/ltomos_premb_mask/premb_mask_ltomos.star'
in_ref_short_key = '0'
in_star = ROOT_PATH + '/pst/nrt/ltomos_clst_flt_high_lap/clst_flt_high_lap_ltomos.star'  # '/pst/nrt/ltomos_clst_flt_high/k4_gather_clst_flt_high_ltomos.star'
in_wspace = None # ROOT_PATH + '/pst/nrt/bi_k4_ves_40_pre_gather_lap_tomos/bi_4_60_5_sim_20_rad_5_wspace.pkl' # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/pst/nrt/bi_ves_40_k4_lap_tomos'
out_stem = 'bi_4_100_5_sim_20_loc_rad_5' # ''uni_sph_4_60_5'

# Analysis variables
ana_res = 0.684 # nm/voxel
ana_rg = np.arange(4, 100, 5) # np.arange(4, 100, 2) # in nm
...
if in_wspace is None:
    ...
    for lkey in list(lists_hash.values()):
        ...
        for tkey in list(tomos_hash.keys()):
            ...
            if os.path.split(tkey)[1] == 'syn_14_17_bin2_rot_crop2_seg.fits':
                print('JOL')
