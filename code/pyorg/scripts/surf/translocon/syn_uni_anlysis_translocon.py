...
# Input STAR file
in_star = ROOT_PATH + '/stat/ltomos/try1_R/try1_ssup_20_ltomos.star' # '/ltomos/control_mask/control_mask_ltomos.star'
in_wspace = None # ROOT_PATH + '/stat/uni/try1_C/shell_tdel_20/uni_5_200_5_20_sim_1_wspace.pkl' # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/stat/uni/try1_R/sph_ssup_20'
out_stem = 'uni_5_200_5_sim_1' # 'uni_4_60_2_sim_10'

# Analysis variables
ana_res = 1.048 # nm/voxel
ana_rg = np.arange(5, 200, 3) # in nm
ana_shell_thick = None # 20 # 10
ana_border = True
...
if fig_fmt is None:
    ...
    plt.savefig(out_lists_dir + '/uni_lists.png')
plt.close()
