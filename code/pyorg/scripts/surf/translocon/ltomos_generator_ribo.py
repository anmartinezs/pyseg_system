...
# Input STAR file
in_star = ROOT_PATH + '/in/in_ltomos_ribo_aln2_all_org.star' # '/in/in_ltomos_ribo_rln_out.star'
...
# Output directory
out_dir = ROOT_PATH + '/ltomos/ribo_rln_aln2_all_org_min_50_ssc_test'
out_stem = 'ost_org_ssup_8_min_50' # 'pre'
...
sg_bm = 'center'
sg_pj = False
sg_origins = [2, 4, 4] # If not None, subtomoavg shiftings are considered, then scale factor from picked particle to subtomograms
sg_voi_mask = True
# Directory for VOI memory maps (to save memory and only used if sg_voi_mask==True)
sg_dmap_path = ROOT_PATH + '/ltomos/ribo_rln_aln2_all_org_min_50_ssc_test/all_org_ssup_8_min_50_ssc_test/dmaps'
