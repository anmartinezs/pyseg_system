...
# Input STAR files
in_star = ROOT_PATH + '/ltomos_omsegs/test/test_ltomos.star'
in_wspace = None

# Output directory
out_dir = ROOT_PATH + '/ana/oms_dsts/test/'
out_stem = 'test_100_250'
...
if in_wspace is None:
    ...
    for lkey in lists_hash.itervalues():
        ...
        for tkey in tomos_hash.iterkeys():
            ...
            out_fils = out_dir + '/' + tkey.replace('/', '_') + '_mb_dsts.mrc'
