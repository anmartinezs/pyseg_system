...
# Input STAR file
in_star = ROOT_PATH + '/ltomos/T07/T07_test_1_ltomos.star'
in_wspace = None # ROOT_PATH + '/uni_2nd/T07_6_300_3_5_sim_5_wspace.pkl' # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/uni_2nd/'
out_stem = 'T07_1_150_1_sim_20'

# Analysis variables
ana_res = 0.896 # nm/voxel
ana_rg = np.arange(1, 150, 1) # in nm
ana_shell_thick = None # 5 # 15 # None
...
# Particle surface
p_vtp = ROOT_PATH + '/in/nsome_cent_dec0.6_res0.896.vtp'
