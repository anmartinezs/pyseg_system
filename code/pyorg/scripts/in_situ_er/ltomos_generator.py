...
# Input STAR file
in_star = ROOT_PATH + '/stat/in_2/plcI_arr10_binsph.star' # '/stat/in/trans_run2_test_sph10.star' # '/in/in_ltomos_ribo_rln_out.star'

# Input STAR for with the sub-volumes segmentations
in_seg = ROOT_PATH + '/stat/in_2/tomo_dose_flt_complete.star' # '/in/in_seg_sp_ribo_rln.star'

# Output directory
out_dir = ROOT_PATH + '/stat/ltomos_v2/plcI_ssup15' # '/stat/ltomos/trans_run2_test_swapxy'
out_stem = 'run1' # 'pre'
...
sg_bm = 'center'
sg_pj = False # True
sg_origins = (4, 4, 4, 4, 4, 4, 4, 4) # [2, 4, 4] # If not None, subtomoavg shiftings are considered, then scale factor from picked particle to subtomograms
...
sg_dmap_path = ROOT_PATH + '/stat/ltomos_v2/plcI_ssup15/dmaps' # '/stat/ltomos/trans_run2_test_swapxy/dmaps'

# Post-processing
pt_res = 1.368 # nm/vx
pt_ssup = 15 # nm
pt_ss_ref = None # ('4', '5', '3', '2', '7', '6', '1', '0') # ('0', '1')
pt_ss_ref_dst = None # 20
pt_min_parts = 1 # 20 # 50 # 20
pt_min_by_tomo = True
pt_keep = None
pt_pparts = False
pt_mode_over = False
