...
ROOT_PATH = os.path.split(os.path.abspath(__file__))[0] + '/../../../../data/tutorials/exp_ssmb/'

# Input STAR file
in_star = ROOT_PATH + '/stat/ltomos/test/test_ssup_8_ltomos.star'
in_wspace = None # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/stat/out/uni_1st'
out_stem = 'test_1st_sim_20' # ''uni_sph_4_60_5'
