"""
    ...
    Output: - A filtered version of the input MbGraphMCF
...
in_sources = ROOT_PATH + '/fils/hold/sources.xml'

# Targets slice XML file
in_targets = ROOT_PATH + '/fils/hold/targets.xml'

####### Output data

out_dir = ROOT_PATH + '/fils/hold'
out_int_g = True
