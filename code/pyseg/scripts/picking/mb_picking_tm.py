"""
    ...
    Script for extracting particles from membranes by template matching
    ...
    Input:  - Directory with the _imod.csv files with reference picked particles for each microsome
            ...
            - Directory with the cross-correlation maps
...
in_dir_cc = ROOT_PATH + '/antonio/pick_test/tm/cc/scores/160614'
in_ctf = ROOT_PATH + '/antonio/pick_test/recontruct/ctf/CTF_model_160.mrc'

####### Output data

out_dir = ROOT_PATH + '/antonio/pick_test/pick/tm/160614'
out_dir_parts = ROOT_PATH + '/antonio/pick_test/recontruct/tm/160614/protein_160'
...
print('\tDirectory for cross-correlation maps: ' + str(in_dir_cc))
...
for in_mic in mic_dic.keys():
    ...
    path_cc = in_dir_cc + '/' + stem_mic + '_cc.em'
    print('\t\t-Loading corresponding cross-correlation map: ' + path_cc)
    try:
    ...
    tomo_peaks = peak_local_max(tomo_cc, min_distance=5, indices=False)
    ...
    out_imod_csv = out_dir + '/' + stem_mic + '_tm_imod.csv'
    ...
    out_rln_coords = out_dir + '/' + stem_mic + '_tm_rln.coords'
...
out_star = out_dir + '/particles_160614_tm.star'
