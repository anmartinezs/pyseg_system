...
ROOT_PATH = '/fs/pool/pool-lucic2/antonio'

# Input STAR file
in_star = ROOT_PATH + '/pick_test/fils/160614/fil_mb_sources_to_lumen_targets_net.star'
in_ctf = ROOT_PATH + '/johannes/tomograms/stefan/ctf/CTF_model_160.mrc'

####### Output data

output_dir = ROOT_PATH + '/pick_test/cont/160614' # '/pick/cyto'
out_dir_parts = ROOT_PATH + '/pick_test/recontruct/ps/160614/protein_160'

###### Slices settings file

slices_file = ROOT_PATH + '/pick_test/cont/in/mb_lumen_cont.xml' # '/in/cyto/mb_cyto_cont.xml'
