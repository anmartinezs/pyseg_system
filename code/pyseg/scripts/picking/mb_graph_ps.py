...
ROOT_PATH = '/fs/pool/pool-lucic2/antonio' # Data path

# Input STAR file with segmentations
in_star = ROOT_PATH + '/pick_test/graphs/in/seg_160614_no_beads_test.star'

####### Output data

output_dir = ROOT_PATH + '/pick_test/graphs/out' # '/graph/cyto'
...
for (row, input_seg) in zip(range(star.get_nrows()), in_seg_l):
