...
ROOT_PATH = '../../../../../data/tracing/mb_single' # Data path

# Input STAR file with the GraphMCF pickles
in_star = ROOT_PATH + '/graph/lumen/in_graph_mb_graph.star' # '/graph/cyto/in_graph_mb_graph.star' # The outuput of mb_graph.py

# Sources slice XML file
in_sources = ROOT_PATH + '/in/mb_sources.xml'

# Targets slice XML file
in_targets = ROOT_PATH + '/in/lumen/lumen_targets.xml' # '/in/cyto/cyto_targets.xml'

####### Output data

out_dir = ROOT_PATH + '/fils/lumen' # '/fils/cyto' 
out_int_g = True

####### Filament geometrical parameters

g_rg_len = [1, 50] # [1, 75] # nm (>0)
g_rg_sin = [0, 3]
g_rg_eud = [1, 25] # [1, 25] # nm (>0)
