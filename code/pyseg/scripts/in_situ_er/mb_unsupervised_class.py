"""
    ...
    Unsupervised and deterministic (AP and HAC yes, Kmeans not) classification of membrane-bound particles
...
in_star = ROOT_PATH + '/rln/nali_sup_klass/mb_oriented_h_dose/run2_c10_it006_data_hold.star' # '/de_novo_klass_3d/mb_unrionted_h_nali_dose_flt_clean_wedge.star'

# Output directory for the star files
out_dir = ROOT_PATH + '/de_novo_klass_3d/test'
out_stem = 'klass_1'

# Particles pre-processing
pp_mask = ROOT_PATH + '/masks/mask_160_75_120_25.mrc' # '/masks/mask_160_35_120_25.mrc'
pp_low_sg = 4 # voxels
...
## Clustering
cu_alg = 'AP' # 'AG' # 'Kmeans'
cu_mode = 'ncc_2dz' # (only valid for 'AP') # 'vectors' #
...
cc_npr = 30 # None # 1 # None # if None then auto
