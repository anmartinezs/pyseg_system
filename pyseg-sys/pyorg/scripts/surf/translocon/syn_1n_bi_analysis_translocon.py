...
in_wspace = None # ROOT_PATH + '/stat/uni/try1_R/bi_sph_ssup_20_min_5/bi_FT_50_5_200_3_sim_1_wspace.pkl' # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/stat/uni/try2_FT/bi_shell_ssup_20_min_5'
out_stem = 'bi_FT_50_5_200_3_sim_1_test' # ''uni_sph_4_60_5'
