...
# Input STAR file
in_star_ref = ROOT_PATH + '/stat/ltomos/ribo_rln_aln2_all_org_fmm/test_1_ltomos.star'  #
in_ref_short_key = '0'
in_star = ROOT_PATH + '/stat/ltomos/ribo_rln_aln2_all_org_fmm/test_1_ltomos.star'  #
...
# Output directory
out_dir = ROOT_PATH + '/stat/uni/ribo_rln_aln2_all_org_fmm/test_1'
