...
key_ref = 'pre'
in_star_1 = ROOT_PATH + '/ves_ap_10/ltomos_ves_ap_10_premb_mask/ves_ap_10_premb_mask_ltomos.star' # '/ves_40/ltomos_lap/lap_ltomos.star'
key_1 = 'tether'
...
# Output directory
out_dir = ROOT_PATH + '/ves_ap/org/aln/coloc_ves_ap_10_vs_pre_ampar_nmdar'
out_stem = 'aln_10_25_5_sim_3_global_maxd_20' # ''uni_sph_4_60_5'
