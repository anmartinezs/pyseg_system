...
# Input STAR file
in_star_ref = ROOT_PATH + '/ves_ap_10/ltomos_ves_ap_10_premb_mask/ves_ap_10_premb_mask_ltomos.star' # '/ves_40/ltomos_lap/lap_ltomos.star'
key_ref = 'tether'
...
# Output directory
out_dir = ROOT_PATH + '/ves_ap/org/coloc/coloc_ves_ap_10_vs_pre_ampar_nmdar'
out_stem = 'coloc_5_60_5_sim_2_max_20' # ''uni_sph_4_60_5'
