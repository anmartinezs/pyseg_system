...
# Input STAR file
in_star = ROOT_PATH + '/in/in_parts_all_iso1.7.star' # '/in/in_parts_all.star'

# Input STAR for with the sub-volumes segmentations
in_seg = ROOT_PATH + '/in/in_seg_all.star' # '/in/in_seg_all.star'

# Output directory
out_dir = ROOT_PATH + '/ltomos/all_iso1.7' # '/ltomos/all_pid' # '/stat/ltomos/trans_run2_test_swapxy'
out_stem = 'all_iso1.7' # 'pre'
