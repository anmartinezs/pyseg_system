...
in_wspace = ROOT_PATH + '/nrt/uni_k4_gather_tomos/uni_sim_100_ss7_wspace.pkl' # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/nrt/uni_k4_gather_tomos'
out_stem = 'uni_sim_100_ss7_pvals' # ''uni_sph_4_60_5'
...
ana_rg = np.arange(4, 200, 5) # np.arange(4, 100, 2) # in nm
