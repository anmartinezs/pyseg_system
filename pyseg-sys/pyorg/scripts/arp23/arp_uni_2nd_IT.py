...
# Input STAR file
in_star = ROOT_PATH + '/ltomos_sep/IT_sep_mask/IT_all_mask_ltomos.star' # '/ltomos_all/W_all_mask/W_all_mask_ltomos.star' # '/ref_a3/ltomos/pre_ltomos.star' # '/ref_a2/ltomos/pre_ref_a2_12_ltomos_hold.star'

# Input matrices (optional - organization analysis is skipped)
in_mats_lists = None # ROOT_PATH + '/uni_sph_sep_IT/IT_sep_sim10_org_lists.pkl' # ROOT_PATH + '/ref_a3/uni_sph/uni_sph_4_60_2_org_list.pkl'

# Output directory
out_dir = ROOT_PATH + '/uni_sph_sep_IT'
out_stem = 'IT_sep_sim10' # ''uni_sph_4_60_5'
...
if mats_lists is not None:
    ...
    for lbli, key in zip(klass_lbls_inv.iterkeys(), klass_lbls_inv.itervalues()):
    ...
    plt.legend(lines, lbls, bbox_to_anchor=(0.05, -0.1, 0.25, 0.45))
