...
class Cleft(Segment):
    ...
    def makeColumns(
        ...
        columns = Segment(data=col_data, ids=bin_ids.keys(), copy=False)
    ...
    def parametrizeLayers(
        ...
        if (system == 'radial') or (self.ndim == 2):
            ...
            if (system == 'polar') or (system == 'cartesian'):
                ...
                for id_, origin in centers.items():                    
            ...
            if (system == 'cartesian') and (metric == 'euclidean'):
                ...
                xyz = numpy.ma.masked_array(xyz_euc, mask=3 * [~ids_mask],
                                            fill_value=noDistance)
                return xyz
