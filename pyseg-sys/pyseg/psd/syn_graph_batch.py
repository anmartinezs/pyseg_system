...
ROOT_PATH = '/home/martinez/pool/pool-lucic2/antonio/tomograms/shoh/syn_batch'

# Input STAR file with segmentations
in_star = ROOT_PATH + '/in/syn_seg_z.star'

####### Output data

# output_dir = ROOT_PATH+'/ex/syn/graphs_3'
output_dir = ROOT_PATH + '/graph_z_simp'
...
print 'Extracting SynGraphMCF from synapses.'
...
for (row, in_tomor, in_seg) in zip(range(star.get_ncols()), in_tomor_l, in_seg_l):
