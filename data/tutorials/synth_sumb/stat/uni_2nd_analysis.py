...
# Input STAR file
in_star = ROOT_PATH + '/ltomos_v2/all_L/all_L_ltomos.star'
in_wspace = None # ROOT_PATH + '/tests/uni_dsa_all/test_8_300_10_sim_20_wspace.pkl' # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/tests/uni_dsa_all/'
out_stem = 'test_8_300_10_sim_3'
...
# Particle surface
p_vtp = ROOT_PATH + '/in/yeast_80S/yeast_80S_21A_mirr_centered.vtp'
